            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3 justify-content-center ">
                        @foreach ($tags as $tag)
                            <div class="feature col-md-5 m-2">
                                <div class="card">
                                    <div class="card-header bg-primary">
                                        <h1 class="text-center m-1">{{ $tag->tag }}</h1>
                                    </div>
                                    <div class="card-body">
                                        <h2 class="mx-3 mt-2 font-bold text-center">
                                            {{ $tag->description }}
                                        </h2>
                        ...
                        @endforeach
                        <div class="feature row col-md-4 m-2">
                            <div class="card">
                                <div class="card-header bg-primary">
                    ...
                    <div class="modal fade" id="createTag{{ Auth::user()->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
